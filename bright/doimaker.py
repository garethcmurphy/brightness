...
class DOIMaker(object):
    ...
    def __init__(self):
        ...
        self.deliv_tags = [16, 25, 26, 27, 32, 33, 34, 35, 36, 411, 412 , 413, 414, 415, 48, 55, 56, 57, 63, 64]
        ...
        self.deliverable_dict = {
            ...
            '16': '3rd-agenda-and-minutes-yearly-general-assembly',
            '17': 'report-methodology-and-criteria-socioeconomic-impact-assessment-ess-during',
            ...
            '25': '2nd-annual-ikc-progress-assessment',
            '26': 'revision-ikc-best-practice-online-platform',
            '27': 'ikc-work-package-assignment-plan',
            '31': '“eric-risk-and-opportunity-plan”',
            '32': 'determine-tt-strategy-and-policy',
            '33': 'invitation-market-consultation',
            '34': 'tender-documents-ppi',
            '35': 'eric-operations-programme',
            '36': 'tto-industry-agreement',
            '41': 'integration-plan-detector-readout',
            '410': 'test-technology-demonstrator',
            '411': 'standarised-test-procedures-performance-detectors-early-ess-instruments',
            '412': 'reflectometry-detectors',
            '413': 'module-nmx-detector',
            '414': 'large-area-detector-spectrometry',
            '415': 'final-verification-brr-moderator',
            ...
            '48': 'monte-carlo-simulations-early-ess-instruments',
            ...
            '55': 'data-aggregator-software',
            '56': 'software-neutron-event-data-processing',
            '57': 'software-fast-field-acquisition',
            '61': 'brightess-section-wwweuropeanspallationsourcese',
            '62': 'results-target-group-online-survey',
            '63': 'three-new-ilo-nodes',
            '64': 'three-new-ess-member-countries-full-member-oberserver-associated-country'
        }
        self.passw = 'tbc'
        self.user = 'tbc'
        ...
        self.deliverable_title = {'11': '1.1: Agenda and minutes of the General Assembly / Kick-off meeting ',
                                  ...
                                  '16': '1.6: 3rd Agenda and minutes of yearly General Assembly',
                                  ...
                                  '25': '2.5: 2nd Annual IKC Progress Assessment',
                                  '26': '2.6: Revision of IKC Best practice online platform',
                                  '27': '2.7: IKC Work Package Assignment Plan',
                                  '31': '3.1: “ERIC Risk and Opportunity Plan”',
                                  '32': '3.2: Determine TT strategy and policy',
                                  '33': '3.3: Invitation to Market Consultation',
                                  '34': '3.4: Tender documents for PPI',
                                  '35': '3.5: ERIC Operations Programme',
                                  '36': '3.6: TTO industry agreement',
                                  '41': '4.1: Integration plan for detector readout ',
                                  '410': '4.10: Test for technology demonstrator ',
                                  '411': '4.11: Standarised test procedures for performance of detectors for early ESS instruments',
                                  '412': '4.12: Reflectometry detectors',
                                  '413': '4.13: Module for NMX detector',
                                  '414': '4.14: Large area detector spectrometry',
                                  '415': '4.15: Final verification of BRR moderator',
                                  ...
                                  '48': '4.8: Monte Carlo simulations for early ESS instruments',
                                  ...
                                  '55': '5.5: Data aggregator software',
                                  '56': '5.6: Software neutron event data processing',
                                  '57': '5.7: Software fast field acquisition',
                                  '61': '6.1: BrightESS section on www.europeanspallationsource.se ',
                                  '62': '6.2: Results of target group online survey ',
                                  '63': '6.3: Three new ILO Nodes',
                                  '64': '6.4: Three new ESS Member Countries (Full Member, Oberserver, Associated Country)'}
        ...
        self.deliverable_abstracts = {
            ...
            '56': '',
            '57': '',
            '61': 'The BrightnESS website serves as the core dissemination tool and the central portal for all project related communication activities. The BrightnESS website is set up as a subsection of the ESS website in order to leverage the existing traffic and thus help to raise awareness about the project. This approach also allows the visitors to navigate easily to the ESS website, which provides detailed information about the next generation research facility standing at the very center of this project. The website is available in English as this is the working language of the consortium of partners. Moreover, content provided in English will help to reach out to large audiences from different countries. The website will be continuously updated through the duration of the project. ',
...
<resource xmlns="http://datacite.org/schema/kernel-4" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="http://datacite.org/schema/kernel-4 http://schema.datacite.org/meta/kernel-4/metadata.xsd">  
  ...
  <resourceType resourceTypeGeneral="Text">Deliverable</resourceType> 
    ...
    def request_post(self, doi, title, abstract, url):
        ...
        datacite_url = 'https://mds.datacite.org/metadata'
        response = requests.post(datacite_url, data=xml.encode('utf-8'), headers=headers,
...
if __name__ == '__main__':
    ...
    for tag1 in deliv:
        ...
        url = "https://brightness.esss.se/about/deliverables/" + \
            tag + "-" + bright.deliverable_dict[tag]
